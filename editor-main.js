    ...
    setupAboutLink() {
        ...
        if (aboutLink) {
            aboutLink.addEventListener('click', async (e) => {
                ...
                const aboutContent = `
                    <div style="line-height: 1.8; font-size: 15px; color: var(--text-color);">
                        <p style="margin-bottom: 1rem;">
                            <strong>Śikṣāmitra</strong> is a project developed by <span style="color: var(--primary-color); font-weight: 600;">Marin Hrvaćanin</span>, a student of Computer Engineering at the 
                            <strong>University of Zagreb, Faculty of Electrical Engineering and Computing (FER)</strong>.
                        </p>
                        <p style="margin-bottom: 1rem;">
                            My deep interest in the Vedas was sparked by the <a href="https://vedaunion.org" target="_blank" style="color: var(--primary-color);">Veda Union</a> organization, 
                            where I have had the privilege of learning the fundamentals of Vedic recitation and tradition. The knowledge I gained there has been instrumental in the creation of this tool.
                        </p>
                        <p style="margin-bottom: 1rem;">
                            This project is a digital homage to the work of <span style="color: var(--primary-color); font-weight: 600;">Davor Virkes</span>. The documents, rules, and marking systems 
                            implemented in this editor are an online reproduction of his extensive research and documentation. Śikṣāmitra aims to digitize and 
                            make accessible his profound work in Sanskrit grammar, semantics, and Vedic pronunciation (Śikṣā), preserving it for future students and practitioners.
                        </p>
                        <p style="margin-bottom: 0;">
                            Special thanks to Davor Virkes for his guidance, inspiration, and for laying the scholarly foundation upon which this tool is built.
                        </p>
                    </div>
                `;
                
                await ModalDialogs.alert(aboutContent, 'About Śikṣāmitra', 'info');
            });
        }
    }
