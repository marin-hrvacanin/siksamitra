...
def main():
    ...
    sec1 = {'id': 'sec-1', 'label': 'Durg\u0101 S\u016bktam',
            'source': 'Taittir\u012bya \u0100ra\u1e47yaka 10.2 \u00b7 Mah\u0101n\u0101r\u0101ya\u1e47a Upani\u1e63ad',
            'verses': [mkverse(f'v-{i+1}', verses[i], str(i + 1)) for i in range(7)]}
    sec2 = {'id': 'sec-2', 'label': 'Durg\u0101 G\u0101yatr\u012b',
            'source': 'Taittir\u012bya \u0100ra\u1e47yaka 10.1.7',
            'verses': [mkverse('v-8', verses[7], '8')]}
    sec3 = {'id': 'sec-3', 'label': '\u015a\u0101ntip\u0101\u1e6dha',
            'source': '\u015b\u0101ntimantra\u1e25',
            'verses': [mkverse('v-9', verses[8], None)]}

    tf_iast = 'durg\u0101 s\u016bktam'
    ...
    doc = {
        ...
        'id': 'durga-suktam',
        'title': tf_iast,
        'subtitle': 'Hymn to Durg\u0101 \u2014 the goddess who carries us over all difficulties',
        'source': 'k\u1e5b\u1e63\u1e47ayajurveda \u00b7 Taittir\u012bya \u0100ra\u1e47yaka 10.2',
        'primaryScript': 'iast',
